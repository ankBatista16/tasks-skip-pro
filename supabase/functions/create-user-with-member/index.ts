...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Pass metadata so the database trigger (handle_new_user) can populate the public.members table
    // This atomic operation ensures consistency between Auth and Members
